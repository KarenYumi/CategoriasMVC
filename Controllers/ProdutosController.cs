...
namespace CategoriasMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            var produto = await _produtoService.GetProdutosPorId(id, ObtemTokenJwt());
        ...
        {
            if (HttpContext.Request.Cookies.ContainsKey("X-Access-Token")) //vai procurar se existe o X-Acces-Token no cookie
                token = HttpContext.Request.Cookies["X-Access-Token"].ToString(); //achou ent envia o token pra IPodutosService gravado neste token
